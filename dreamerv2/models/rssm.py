...
from agents.dreamerv2.dreamerv2.utils.rssm import (
    RSSMUtils,
    RSSMContState,
    RSSMDiscState,
)
...
class RSSM(nn.Module, RSSMUtils):
    ...
    def rollout_observation(
        ...
        for t in range(seq_len):
            ...
            prior_rssm_state, posterior_rssm_state = self.rssm_observe(
                obs_embed[t], prev_action, nonterms[t], prev_rssm_state
            )
